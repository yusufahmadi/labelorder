...
//                }
        ...
        recyclerAdapter = new RibbonRecyclerAdapter(getActivity(), recyclerView, new ArrayList<Ribbon>(), item_limit);
        recyclerView.setAdapter(recyclerAdapter);
        recyclerAdapter.setOnLoadMoreListener(new RibbonRecyclerAdapter.OnLoadMoreListener() {
            @Override
    ...
    private void refreshList(String Filter, int iPage, int iLimit) {
        List<Ribbon> Items = new ArrayList<>();
        try {
            ...
            Items = DataAccess.getListRibbon(getActivity(), Filter, iPage, iLimit);
