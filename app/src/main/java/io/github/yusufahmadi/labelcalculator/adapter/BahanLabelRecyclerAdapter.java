...
public class BahanLabelRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BahanLabelRecyclerAdapter(Context context, RecyclerView view, List<Bahan> items, int item_limit) {
